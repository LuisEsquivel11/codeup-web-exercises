$(() => {
                ...
                todaysCard.html(`
                    <div class="d-flex column pb-2">
                        <div class="col-6 d-flex gap-2 justify-content-start">
                            <h3 class="text-center text-info mt-2 ms-5 display-1 ">${data.list[0].main.temp}˚F</h3>
                            <p class="text-center text-info mb-5 mt-2">${data.list[0].main.temp_max}˚/${data.list[0].main.temp_min}˚</p>
                        </div>
                        <div class="d-flex flex-column text-info justify-content-center mx-5 ">
                            <p class="text-center text-info">${data.list[0].weather[0].description}</p>
                        </div>
                    </div>
                    <div class="d-flex flex-row align-items-center h-50 text-shadow-1 border-bottom border-info px-3 pt-1">
                        <ul class="flex-column list-unstyled">
                            <li class="d-flex align-items-center me-3">
                                <h4 class="text-center text-info fs-3"> Feels like ${data.list[0].main.feels_like}˚</h4>
                            </li>
                            <li class="d-flex align-items-center me-3">
                                <h5 class="text-info">Humidity: ${data.list[0].main.humidity}%</h5>
                            </li>
                            <li class="d-flex align-items-center">
                                <small class="text-info">wind ${data.list[0].wind.speed}/mph</small>
                            </li>
                        </ul>
                    </div>
                    <div>
    ...
    $.ajax(getTodaysWeatherURL( 29.4252, -98.4916)).done(data => {
        console.log(data)
    })
